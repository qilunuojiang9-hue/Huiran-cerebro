...
<div class="searchbar">
  <input id="q" placeholder="搜什么？例如：收款 / 企鹅号 / 选题 / 发布红线 / 某客户" onkeydown="if(event.key==='Enter')doSearch()">
...
<div id="panel-rel" class="panel hidden">
  <div class="card">
    ...
    <div class="form-row">
      <div style="flex:3"><input id="relQ" placeholder="如：某公司 / 某客户 / 某客户" onkeydown="if(event.key==='Enter')searchEntity()"></div>
...
<div id="panel-ask" class="panel hidden">
  <div class="card">
    ...
    <div class="hint">直接对赛博大脑提问，例如「我们给某客户定过什么红线？」「root服务哪些客户？」「发布铁律是什么？」。答案由火山方舟 LLM 基于库内记忆/文档生成。</div>
    <div class="form-row">
